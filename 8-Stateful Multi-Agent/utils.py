...
def add_user_query_to_history(session_service, app_name, user_id, session_id, user_query):
    ...
    update_interaction_history(session_service, app_name, user_id, session_id, entry)
...
def add_agent_response_to_history(session_service, app_name, user_id, session_id, agent_name, response):
    ...
    Args:
        ...
        user_id: The user ID
        session_id: The session ID
        agent_response: The agent's response string
    """
    entry = {
